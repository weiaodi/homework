  ...
  >
    ...
    >
      ...
      >
        ...
        <h1>简介:</h1>
        <p
          class="h-64 overflow-auto italic font-bold text-xl text-white"
          style="text-indent: 2em"
        >
          {{ getProduct.introduce }}
        </p>

        <!-- 产品图：移除绝对定位和偏移缩放，改为正常流式布局，解决溢出问题 -->
        <section class="w-full h-48 my-6 rounded-lg overflow-hidden">
          <el-image
            v-if="getProduct.poster"
